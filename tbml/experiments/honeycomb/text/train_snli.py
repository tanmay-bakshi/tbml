...
def main() -> None:
    ...
    def train_step(
        ...
        def _loss_fn(bundle_inner: SnliBundle) -> tuple[Array, Array]:
            ...
            pooled_p = model_inner(premise_tokens, premise_mask, train=model_train, key=premise_key)
            pooled_h = model_inner(
                hypothesis_tokens, hypothesis_mask, train=model_train, key=hypothesis_key
            )
